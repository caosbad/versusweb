          ...
          <div className="py-12 bg-white">
            <div className="container">
              ...
              <div className="mt-8">
                ...
                <p className="mb-4">
                  This privacy policy is for this website www.versus-flow.art,
                  provided by company name and governs the privacy of its users
                  who choose to use it.
                </p>
                <p className="mb-4">
                  The policy sets out the different areas where user privacy is
                  concerned and outlines the obligations &amp; requirements of
                  the users, the website and website owners. Furthermore, the
                  way this website processes, stores and protects user data and
                ...
                <h2 className="text-xl font-semibold mb-4">The Website</h2>
                <p className="mb-4">
                  ...
                  This website complies to all UK national laws and requirements
                  for user privacy.
                </p>
                ...
                <p className="mb-4">
                  Cookies are small files saved to the user’s computers hard
                ...
                <p className="mb-4">
                  ...
                  The software will save a cookie to your computers hard drive
                ...
                <p className="mb-4">
                  ...
                  products/services they offer or to assist you in answering any
                ...
                <h2 className="text-xl font-semibold mb-4">Email Newsletter</h2>
                <p className="mb-4">
                  This website operates an email newsletter program, used to
                  inform subscribers about products and services supplied by
                  this website. Users can subscribe through an online automated
                  process should they wish to do so but do so at their own
                  discretion. Some subscriptions may be manually processed
                  through a prior written agreement with the user.
                </p>
                <p className="mb-4">
                  Subscriptions are taken in compliance with UK Spam Laws
                  ...
                  Data Protection Act 1998. No personal details are passed on to
                  third parties nor shared with companies/people outside of the
                  company that operates this website. Under the Data Protection
                  Act 1998 you may request a copy of personal information held
                  about you by this website’s email newsletter program. A small
                ...
                <p className="mb-4">
                  Email marketing campaigns published by this website or its
                  owners may contain tracking facilities within the actual
                ...
                <p className="mb-4">
                  This information is used to refine future email campaigns and
                  supply the user with more relevant content based on their
                  activity.
                </p>
                <p className="mb-4">
                  In compliance with UK Spam Laws and the Privacy and Electronic
                  Communications Regulations 2003 subscribers are given the
                  opportunity to unsubscribe at any time through an automated
                  system. This process is detailed at the footer of each email
                  campaign. If an automated un-subscription system is
                  unavailable, clear instructions on how to un-subscribe will be
                  detailed instead.
                </p>
                <h2 className="text-xl font-semibold mb-4">External Links</h2>
                <p className="mb-4">
                  Although this website only looks to include quality, safe and
                  relevant external links, users are advised to adopt a policy
                  of caution before clicking any external web links mentioned
                  throughout this website. (External links are clickable
                  text/banner/image links to other websites, similar to;
                  thisiscaffeine.com.)
                </p>
                <p className="mb-4">
                ...
                <p className="mb-4">Adverts and Sponsored Links</p>
                <p className="mb-4">
                ...
                <p className="mb-4">
                  v.1.0 April 2020 Edited &amp; customised by company name
                </p>
                <p className="mb-4">
                  The <b className="text-bold">company name</b> is a company
                  registered in England &amp; Wales under the Registration
                  number: xxxxx
                </p>
              </div>
            </div>
