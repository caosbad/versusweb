        ...
        <div className="container">
          ...
          <div className="mt-8">
            ...
            <p className="mb-4">
              ...
              provided by company name and governs the privacy of its users who
              choose to use it.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              use, as detailed in the Data Protection Act 1998. Every effort has
              been made to ensure a safe and secure form to email submission
              process but advise users using such form to email processes that
            ...
            <p className="mb-4">
              ...
              subscriptions may be manually processed through a prior written
              agreement with the user.
            </p>
            <p className="mb-4">
              Subscriptions are taken in compliance with UK Spam Laws detailed
              in the Privacy and Electronic Communications Regulations 2003. All
              personal details relating to subscriptions are held securely and
              in accordance with the Data Protection Act 1998. No personal
            ...
            <p className="mb-4">
              ...
              clear instructions on how to un-subscribe will be detailed
              instead.
            </p>
            ...
            <p className="mb-4">
              ...
              web page respectively through your social media platform account.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              registered in England &amp; Wales under the Registration number:
              xxxxx
            </p>
          </div>
        </div>
