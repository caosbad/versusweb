          ...
          <div className="py-12 bg-white">
            <div className="container">
              ...
              <div className="mt-8">
                ...
                <p className="mb-4">
                  You can think of Versus like Instagram meets Christies. A new
                  way to interact with art, culture, and collecting on the
                  internet!
                </p>
                ...
                <p className="mb-4">
                  Each artwork on Versus is a digital collectible– a digital
                  object secured by cryptography and tracked on the blockchain.
                  That’s just a fancy way of saying they’re provably scarce
                  items that can be collected, and that hold value just like
                ...
                <p className="mb-4">
                  Sign up here to create an account and connect it with an
                  Ethereum wallet. Once you have an account, check out the
                  activity feed and follow some of your favorite artists to get
                  inspired and start collecting.
                </p>
                <h2 className="text-xl font-semibold mb-4">
                ...
                <p className="mb-4">
                  ...
                  Coinbase is an easy place to buy ether using a bank account if
                  you haven’t used cryptocurrencies before.
                </p>
                <h2 className="text-xl font-semibold mb-4">
                  How does it work for creators?
                </h2>
                <p className="mb-4">
                  Versus is still in early access, onboarding only a small
                  number of hand-picked artists. You can use this form to submit
                  your artist profile and get on our radar for our full launch
                  next year.
                </p>
                <h2 className="text-xl font-semibold mb-4">
                ...
                <p className="mb-4">
                  There is a simple 3% transaction fee for all purchases, paid
                  by the buyer.
                </p>
                <h2 className="text-xl font-semibold mb-4">
                ...
                <p className="mb-4">
                  ...
                  85%). For secondary sales, creators receive a 10% commission
                  (aka royalty), providing passive revenue from an artwork if it
                  continues to trade on the secondary market.
                </p>
                <h2 className="text-xl font-semibold mb-4">
                  What about fees/commissions for artworks created during the
                  beta phase?
                </h2>
                <p className="mb-4">
                ...
                <h2 className="text-xl font-semibold mb-4">
                  What's the motivation behind secondary market artist
                  royalties?
                </h2>
                <p className="mb-4">
                  We think the ability to secure a percentage of
                  secondary-market revenue for artists is one of the most
                  revolutionary and exciting capabilities provided by Ethereum
                  smart contracts. It’s analogous to a musician receiving a
                  percentage of sales for a vinyl record issued, say, in the
                  1960s and still being bought and sold in used record stores
                  today.
                </p>
                <h2 className="text-xl font-semibold mb-4">
